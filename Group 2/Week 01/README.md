...
### Unscoped enumеrations (plain enums) vs Scoped enumеrations (enum class)
...
Извод: Винаги използвайте enum class, за да избегнете имплицитното преобразуване и двусмислици.
...
| Извикана функция / Викаща функция | A obj | const A obj | A& ref | const A& ref | A\* ptr | const A\* ptr |
| --------------------------------- |-------| --------------- | ---------- | ---------------- | ----------- | ----------------- |
| **f1(A obj)**         |✅|✅|✅|✅|❌|❌|
| **f2(const A obj))**  |✅|✅|✅|✅|❌|❌|
| **f3(A& ref))**       |✅|❌|✅|❌|❌|❌|
